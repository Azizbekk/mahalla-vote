...
import TelegramUserForm from '../form/telegram-user-form.vue';
import TelegramUserDelete from '../delete/telegram-user-delete.vue';
import TelegramUserView from '../view/telegram-user-view.vue';
import { useTelegramUserPaging } from './telegram-user-paging';

const { state, meta, actions } = useTelegramUserPaging();
</script>
  ...
  <div class="q-pa-md">
    ...
    >
      ...
      <template #top>
        <div class="row items-center full-width">
          <div class="text-h6">{{ $t('telegramUser.title') }}</div>
          <q-space />
      ...
      <template #body-cell-state="props">
        <q-td :props="props">
          <q-badge :color="props.value === 'HOME' ? 'green' : props.value === 'AWAITING_PHONE' ? 'orange' : 'blue'" :label="props.value" />
        </q-td>
      </template>
      ...
      <q-card style="min-width: 550px">
        <q-toolbar class="bg-primary text-white">
          <q-toolbar-title>
            ...
            {{ state.formDialog.mode === 'edit' ? $t('telegramUser.editTitle') : $t('telegramUser.createTitle') }}
          </q-toolbar-title>
    ...
    <q-dialog v-model="state.deleteDialog.show" persistent>
      <q-card style="min-width: 450px">
        ...
        <TelegramUserDelete :item="state.deleteDialog.item" @deleted="actions.handleDeleted" @cancel="actions.closeDeleteDialog()" />
      </q-card>
    </q-dialog>
