...
import ReferralForm from '../form/referral-form.vue';
import ReferralDelete from '../delete/referral-delete.vue';
import ReferralView from '../view/referral-view.vue';
import { useReferralPaging } from './referral-paging';

const { state, meta, actions } = useReferralPaging();
</script>
  ...
  <div class="q-pa-md">
    ...
    >
      ...
      <template #top>
        <div class="row items-center full-width">
          <div class="text-h6">{{ $t('referral.title') }}</div>
          <q-space />
      ...
      <template #body-cell-status="props">
        <q-td :props="props">
          <q-badge
            :color="props.value === 'REGISTERED' ? 'grey' : props.value === 'VOTED' ? 'green' : props.value === 'PAID' ? 'blue' : 'grey'"
            :label="props.value"
          />
        </q-td>
      </template>
      ...
      <q-card style="min-width: 550px">
        <q-toolbar class="bg-primary text-white">
          <q-toolbar-title>
            ...
            {{ state.formDialog.mode === 'edit' ? $t('referral.editTitle') : $t('referral.createTitle') }}
          </q-toolbar-title>
    ...
    <q-dialog v-model="state.deleteDialog.show" persistent>
      <q-card style="min-width: 450px">
        ...
        <ReferralDelete :item="state.deleteDialog.item" @deleted="actions.handleDeleted" @cancel="actions.closeDeleteDialog()" />
      </q-card>
    </q-dialog>
